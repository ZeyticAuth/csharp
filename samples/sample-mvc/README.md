...
This sample project shows how to use the [ZeyticAuth ASP.NET Core authentication middleware](../src/ZeyticAuth.AspNetCore.Authentication/) to authenticate users with ZeyticAuth in an MVC application.
