...
public static class ZeyticAuthParameters
{
  ...
  /// <summary>
  /// The scope names used by ZeyticAuth OpenID Connect provider to request for user information.
  /// </summary>
  public static class Scopes
  {
    /// <summary>
    /// The scope name for requesting user's email.
    /// ZeyticAuth will issue two claims to the ID token: <c>email</c> and <c>email_verified</c>.
    /// </summary>
    public const string Email = "email";
    /// <summary>
    /// The scope name for requesting user's phone number.
    /// ZeyticAuth will issue two claims to the ID token: <c>phone</c> and <c>phone_verified</c>.
    /// </summary>
    public const string Phone = "phone";
    /// <summary>
    /// The scope name for requesting user's custom data.
    /// ZeyticAuth will issue a claim to the response of the <c>userinfo</c> endpoint: <c>custom_data</c>.
    /// <br/>
    /// Note that when requesting this scope, you must set <see cref="ZeyticAuthOptions.GetClaimsFromUserInfoEndpoint"/> to <c>true</c>.
    /// </summary>
    public const string CustomData = "custom_data";
    /// <summary>
    /// The scope name for requesting user's identities.
    /// ZeyticAuth will issue a claim to the response of the <c>userinfo</c> endpoint: <c>identities</c>.
    /// <br/>
    /// Note that when requesting this scope, you must set <see cref="ZeyticAuthOptions.GetClaimsFromUserInfoEndpoint"/> to <c>true</c>.
    /// </summary>
  ...
  /// <summary>
  /// The claim names used by ZeyticAuth OpenID Connect provider for ID token and userinfo endpoint.
  /// </summary>
  ...
  /// <summary>
  /// The authentication parameters for ZeyticAuth sign-in experience customization.
  /// </summary>
  public static class Authentication
  {
    /// <summary>
    /// The first screen to show in the sign-in experience.
    /// See <see href="https://docs.zeytic.com/docs/references/openid-connect/authentication-parameters/#first-screen"/> for more details.
    /// </summary>
    ...
    /// See <see href="https://docs.zeytic.com/docs/references/openid-connect/authentication-parameters/#direct-sign-in"/> for more details.
    /// </summary>
