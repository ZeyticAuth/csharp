...
/// <summary>
/// Options for configuring ZeyticAuth authentication.
/// </summary>
public class ZeyticAuthOptions
{
  /// <summary>
  /// The endpoint for the ZeyticAuth server, you can get it from the integration guide or the application details page.
  /// </summary>
  /// <example>
  /// https://foo.app.zeytic.dev/
  /// </example>
  ...
  /// See <a href="https://docs.zeytic.com/docs/recipes/rbac/">RBAC</a> to learn more about how to use role-based access control (RBAC) to protect API resources.
  /// </summary>
  ...
  /// <br/>
  /// It should be the same as the one you configured in the ZeyticAuth Console.
  /// </summary>
